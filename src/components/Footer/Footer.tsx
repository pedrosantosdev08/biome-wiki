...
export function Footer() {
  ...
  return (
    <footer className="relative w-full min-h-[60vh] flex flex-col justify-center items-center py-16 px-8 text-center text-white
      ...
      <div className="w-[90%] max-w-[1200px] h-px bg-white/10 mb-8" aria-hidden="true" />

      <div className="w-[90%] max-w-[1200px] flex flex-col md:flex-row justify-between items-center text-sm text-white/50 gap-4">
